...
LONG_TERM_CYCLE_COUNTS = 70 * WEEKS_OF_YEAR  # 70 years in weeks
SHORT_TERM_CYCLE_COUNTS = 10 * WEEKS_OF_YEAR  # 10 years in weeks
...
# NOTE:
# PLACEHOLDER VALUES
LAM_ARTHROPATHY = 0.0015  # Rate of joint bleeding that may cause arthropathy passed to poisson distribution as lambda value
